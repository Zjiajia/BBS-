...
<!--banner-->
	...
	<div id="education" class="education">
		<div class="container">
			<h3 style="font-family:黑体;color:#4e79a7" class="title">同生源地人脉推荐</h3>
			<div class="typo">
			<%
				Op op=new Op();
			                List<by_student_info>list=op.getby_student_info("select top 10 * from by_student_info where year='2014' and birthplace='江西省' and stu_id !='ec978b4c663ccbbd0bc1995e1dcf1a9e' order by stu_id");
			%>
			<div class="page-header">
				<h3 class="bars" style="font-family:微软雅黑">学生列表</h3>
			</div>
			<div class="bs-docs-example">
				<table class="table table-hover">
					...
					<tbody>
						<%
							for(by_student_info dd:list){
						   						out.print("<tr>");
						   						out.print("<td>"+dd.getstu_id()+"</td>");
						   						out.print("<td>"+dd.getsex()+"</td>");
						   						out.print("<td>"+dd.getyear()+"</td>");
						   						out.print("<td>"+dd.getdepartment()+"</td>");
						   						out.print("<td>"+dd.getbirthplace()+"</td>");
						   						out.print("</tr>");
						   			}
						%>
